...
import net.ludocrypt.limlib.impl.world.LiminalMazeRegistry;
...
public abstract class MazeGenerator {
	...
	public static final Codec<MazeGenerator> CODEC = LiminalMazeRegistry.MAZE_GENERATOR.getCodec().dispatchStable(MazeGenerator::getCodec, Function.identity());
